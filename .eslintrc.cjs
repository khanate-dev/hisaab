...
module.exports = {
			...
			"warn",
			{
				paths: [
					...
					},
					{
						...
						message: "Use useAppColorSchema hook",
					},
					{
						name: "react-router",
					...
					},
					{
						...
						message: "Please import useTheme helper from the theme hook",
					},
					{
						name: "react-native-paper",
						importNames: [
						...
						message: "Please import the local component with the same name",
					},
					{
						name: "react-native",
	...
	overrides: [
		...
		{
			files: ["app/routes.ts", "app/root.tsx", "**/*.route.tsx"],
			rules: {
